...
public class MySQLQueries {
    ...
    public static final String UPDATE_USER = "UPDATE user SET id = ?, firstname = ?, lastname = ?, email = ?, password = ?, gender = ?, role = ? " +
            "WHERE id = ?, firstname = ?, lastname = ?, email = ?, password = ?, gender = ?, role = ?";
    public static final String UPDATE_PUBLICATION = "UPDATE publication SET id = ?, topic = ?, price = ?, content = ?" +
            "WHERE id = ?, topic = ?, price = ?, content = ?";
}
