        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <c:if test="${!empty sessionScope}">
                            <a class="nav-link" href="updatePublication.jsp">Update Periodicals</a>
                        </c:if>
                    </li>
                    <li class="nav-item">
...
<div class="banner header-text">
    <div class="owl-banner owl-carousel">
        ...
        <div class="banner-item-02">
            <div class="text-content">
                <h4>Flash Deals</h4>
                <h2>Get your best periodicals</h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-heading">
                    ...
                    <a href="publications.jsp">view all products <i class="fa fa-angle-right"></i></a>
                </div>
            </div>
            <div class="col-md-4">
