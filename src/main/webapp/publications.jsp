    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="filters">
                    <ul>
                        <li class="active" data-filter="*">All periodicals</li>
                ...
                <div class="filters-content">
                    <div class="row grid">
                        <div class="col-lg-4 col-md-4 all des">
                            <c:forEach items="${listOfPublication}" var="publication">
                                <div class="product-item">
                                    <a href="#"><img src="assets/images/product_01.jpg" alt=""></a>
                                    <div class="down-content">
                                        <a href="#"><h4>${publication.topic}</h4></a>
                                        <h6>${publication.price}$</h6>
                                        ...
                                        <c:if test="${!empty sessionScope}">
                                            ...
                                            <form method="get" action="/updatePublication">
                                                <input type="hidden" name="id" value="${publication.id}">
                                                <input type="submit" value="Edit">
                                            </form>
                                            <form method="post" action="/removePublication">
                                                <input type="hidden" name="id" value="${publication.id}">
